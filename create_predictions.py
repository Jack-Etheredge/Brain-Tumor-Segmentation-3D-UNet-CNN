...
def predict_unet(num_outputs):
    train_val_test_dict = pickle.load(open( "./channel_split/train_val_test_dict.pkl", "rb" ) ) # this has the test/train ID matches

    pickle.dump( results.history, open( f"./weights/history_{num_outputs}_pred.pkl", "wb" ) )
    ...
    validation_generator = DataGenerator(train_val_test_dict['holdout'], num_outputs, **params)

    predictions = model.predict_generator(generator=validation_generator)

    pickle.dump( predictions, open( f"./weights/predictions_{num_outputs}_pred.pkl", "wb" ) )
